...
func DownloadOaRequestFormatSinvest(c echo.Context) error {
	...
	txtHeader := "Type|SA Code|SID|First Name|Middle Name|Last Name|Country of Nationality|ID No|ID Expiration Date|NPWP No|NPWP Registration Date|Country of Birth|Place of Birth|Date of Birth|Gender|Educational Background|Mother Maiden Name|Religion|Occupation|Income Level (IDR)|Marital Status|Spouse Name|Investor Risk Profile|Investment Objective|Source of Fund|Asset Owner|KTP Address|KTP City Code|KTP Postal Code|Correspondence Address|Correspondence City Code|Correspondence City Name|Correspondence Postal Code|Country of Correspondence|Domicile Address|Domicile City Code|Domicile City Name|Domicile Postal Code|Country of Domicile|Home Phone|Mobile Phone|Facsimile|Email|Statement Type|FATCA (Status)|Foreign TIN|Foreign TIN Issuance Country|REDM Payment Bank BIC Code 1|REDM Payment Bank BI Member Code 1|REDM Payment Bank Name 1|REDM Payment Bank Country 1|REDM Payment Bank Branch 1|REDM Payment ACC CCY 1|REDM Payment ACC No 1|REDM Payment ACC Name 1|REDM Payment Bank BIC Code 2|REDM Payment Bank BI Member Code 2|REDM Payment Bank Name 2|REDM Payment Bank Country 2|REDM Payment Bank Branch 2|REDM Payment ACC CCY 2|REDM Payment ACC No 2|REDM Payment ACC Name 2|REDM Payment Bank BIC Code 3|REDM Payment Bank BI Member Code 3|REDM Payment Bank Name 3|REDM Payment Bank Country 3|REDM Payment Bank Branch 3|REDM Payment ACC CCY 3|REDM Payment ACC No 3|REDM Payment ACC Name 3|Client Code"
	...
	for _, oareq := range oaRequestDB {
		if n, ok := pdData[oareq.OaRequestKey]; ok {
			...
			if err == nil {
				...
				data.REDMPaymentACName1 = bankPriority.AccountHolderName
				if bankPriority.BranchName != nil {
					data.REDMPaymentBankBranch1 = *bankPriority.BranchName
				}
			}
