...
func DetailPromo(c echo.Context) error {
	...
	dir := config.ImageUrl + "/images/promo/"
...
func CheckPromo(c echo.Context) error {
	...
	err, enable, text, _ := validatePromo(promoCode, customerKey, productKey, &transactionKey)
...
func validatePromo(promoCode string, customerKey string, productKey string, transactionKey *string) (error, bool, string, *string) {
	var err error
