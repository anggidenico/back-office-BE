...
func GetAdminCmsPostList(c echo.Context) error {
	...
	for _, post := range posts {
		...
		if post.RecImage1 != nil && *post.RecImage1 != "" {
			data.RecImage1 = config.ImageUrl + "/images/post/" + dir + "/" + *post.RecImage1
		} else {
			data.RecImage1 = config.ImageUrl + "/images/post/default.png"
		}
...
func GetAdminCmsPostData(c echo.Context) error {
	...
	if post.RecImage2 != nil && *post.RecImage2 != "" {
		responseData.RecImage2 = config.ImageUrl + "/images/post/" + dir + "/" + *post.RecImage2
	} else {
		responseData.RecImage2 = config.ImageUrl + "/images/post/default.png"
	}
