...
func UpdateTrTransactionSettlementByKeyIn(params map[string]string, valueIn []string, fieldIn string) (int, error) {
	query := "UPDATE tr_transaction_settlement SET "
	// Get params
	i := 0
	for key, value := range params {
...
func UpdateTrTransactionSettlementExpired(params map[string]string, value []string) (int, error) {
	inQuery := strings.Join(value, ",")
	query := "UPDATE tr_transaction_settlement SET "
	// Get params
	i := 0
...
func UpdateTrTransactionSettlementByField(params map[string]string, value string, field string) (int, error) {
	query := "UPDATE tr_transaction_settlement SET "
	// Get params
	i := 0
	for key, value := range params {
